...
export async function resolveAuth(authMode = "auto") {
  ...
  if (authMode === "tenant") {
    ...
    return { mode: "tenant", appId: envAppId, appSecret: envAppSecret };
  }
...
/**
 * Run OAuth login flow (v2 OAuth, no PKCE).
 */
export async function oauthLogin(client, appId, options = {}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const server = createServer(async (req, res) => {
      ...
      try {
        ...
        await saveTokens(appId, tokenData);
