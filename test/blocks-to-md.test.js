...
function textBlock(id, content, style = {}) {
  return {
    block_id: id,
    block_type: 2,
    children: [],
...
function bulletBlock(id, content, childIds = []) {
  return {
    block_id: id,
    block_type: 12,
    children: childIds,
...
function orderedBlock(id, content, childIds = []) {
  return {
    block_id: id,
    block_type: 13,
    children: childIds,
...
function quoteBlock(id, content) {
  return {
    block_id: id,
    block_type: 15,
    children: [],
...
function imageBlock(id, fileToken) {
  return {
    block_id: id,
    block_type: 27,
    children: [],
